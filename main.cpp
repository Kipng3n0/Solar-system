...
int main()
{
	...
	std::cout << "Developed by Dominic Kipkorir" << std::endl;
	...
	*/
	...
	float mercuryRadius = 1.4f * scale;
	float venusRadius = 2.5f * scale;
	float earthRadius = 3.0f * scale;
	float moonRadius = 2.13f * scale;
